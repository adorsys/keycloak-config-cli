...
| --keycloak.connnect-timeout-in-seconds                | KEYCLOAK_CONNECTTIMEOUTINSECONDS                   | Connect timeout of the underyling Resteasy client                                 | 10          |                                                                                                                                 |
| --keycloak.read-timeout-in-seconds                    | KEYCLOAK_READTIMEOUTINSECONDS                      | Read timeout of the underlying Resteasy cloent                                    | 10          |                                                                                                                                 |
