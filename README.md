...
| --import.deep                                         | IMPORT_DEEP                                        | Look for config file in subdirectories (if `--import.path` is a directory)        | `false`     |                                                                                                                                 |
| --import.include                                      | IMPORT_INCLUDE                                     | Include config files from glob pattern (if `--import.path` is a directory)        | -           |                                                                                                                                 |
| --import.exclude                                      | IMPORT_EXCLUDE                                     | Exclude config files from glob pattern (if `--import.path` is a directory)        | -           |                                                                                                                                 |
