...
<br />
<br />
   ![Login](./static/images/quickstart/login.png)
<br />
<br />
3. Select the **realmWithClients** realm from the dropdown
<br />
<br />
   ![Select Realm](./static/images/quickstart/choose_realm.png)
<br />
<br />
4. Navigate to **Clients** in the left menu Click on **moped-client** to view details
<br />
<br />
   ![Moped Client](./static/images/quickstart/choose_client.png)
<br />
<br />
5. Confirm the values match the configuration file
<br />
<br />
   ![Client Details](./static/images/quickstart/client_details.png)
...
<br />
<br />
![Delete Client](./static/images/quickstart/moped_client.png)
<br />  
<br />
...
- Check [supported features](./config/supported-features.md)
