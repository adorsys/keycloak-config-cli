...
public class ImportIdentityProvidersIT extends AbstractImportTest {
    ...
    private void shouldCreateIdentityProvider() {
        ...
        assertThat(config.get("hideOnLoginPage"), is(""));
        ...
        assertThat(config.get("backchannelSupported"), is(""));
        assertThat(config.get("signatureAlgorithm"), is("RSA_SHA256"));
        assertThat(config.get("wantAssertionsEncrypted"), is(""));
        assertThat(config.get("useJwksUrl"), is("true"));
        assertThat(config.get("wantAssertionsSigned"), is(""));
        assertThat(config.get("postBindingAuthnRequest"), is("true"));
        assertThat(config.get("forceAuthn"), is(""));
        ...
        assertThat(config.get("allowedClockSkew"), is(""));
    ...
    private void shouldCreateOtherIdentityProvider() {
        ...
        assertThat(updatedIdentityProviderConfig.get("hideOnLoginPage"), is(""));
        ...
        assertThat(updatedIdentityProviderConfig.get("backchannelSupported"), is(""));
        assertThat(updatedIdentityProviderConfig.get("signatureAlgorithm"), is("RSA_SHA256"));
        assertThat(updatedIdentityProviderConfig.get("wantAssertionsEncrypted"), is(""));
        assertThat(updatedIdentityProviderConfig.get("useJwksUrl"), is("true"));
        assertThat(updatedIdentityProviderConfig.get("wantAssertionsSigned"), is(""));
        assertThat(updatedIdentityProviderConfig.get("postBindingAuthnRequest"), is("true"));
        assertThat(updatedIdentityProviderConfig.get("forceAuthn"), is(""));
        ...
        assertThat(updatedIdentityProviderConfig.get("allowedClockSkew"), is(""));
        ...
        assertThat(createdIdentityProviderConfig.get("hideOnLoginPage"), is(""));
        ...
        assertThat(createdIdentityProviderConfig.get("backchannelSupported"), is(""));
        assertThat(createdIdentityProviderConfig.get("signatureAlgorithm"), is("RSA_SHA256"));
        assertThat(createdIdentityProviderConfig.get("wantAssertionsEncrypted"), is(""));
        assertThat(createdIdentityProviderConfig.get("useJwksUrl"), is("true"));
        assertThat(createdIdentityProviderConfig.get("wantAssertionsSigned"), is(""));
        assertThat(createdIdentityProviderConfig.get("postBindingAuthnRequest"), is("true"));
        assertThat(createdIdentityProviderConfig.get("forceAuthn"), is(""));
        ...
        assertThat(createdIdentityProviderConfig.get("allowedClockSkew"), is(""));
